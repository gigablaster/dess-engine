...
pub struct DeviceCreateDesc {
    ...
    pub update_after_bind_descriptors: usize,
}

impl DeviceCreateDesc {
    pub fn new(instance: Instance, pdevice: PhysicalDevice) -> Self {
        Self {
            instance,
            pdevice,
            update_after_bind_descriptors: 0,
        }
    }

    pub fn update_after_bind_descriptors(mut self, value: usize) -> Self {
        self.update_after_bind_descriptors = value;
        self
    }
}

impl Device {
    pub fn new(desc: DeviceCreateDesc) -> Result<Arc<Self>> {
        let pdevice = desc.pdevice;
